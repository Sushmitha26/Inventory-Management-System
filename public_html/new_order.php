...
<body>
	<!--there will be delay in loading live server,so delay effect is given-->
				...
				<div class="card" style="box-shadow: 0 0 25px 0 lightgrey;">
				  ...
				  <div class="card-body">
				  	...
				  	<form id="get_order_data" onsubmit="return false">
				  		...
				  		<div class="form-group row">  <!--take a row inside form group-->
	                    ...
	                    <center>
	                      ...
	                      <input type="submit" id="print_invoice" style="width:150px;" class="btn btn-success d-none" value="Print Invoice"> <!--d-none is bootstrap class to hide things from the page-->
	                    </center>
